...
from app.routers import videos_delete, videos_ops, videos_thumb, shares, videos_ops_v2
from app.routers import speakers_rename
...
app.include_router(videos_ops_v2.router, prefix="/api/videos", tags=["videos"])
app.include_router(speakers_rename.router, prefix="/api/videos", tags=["videos"])
